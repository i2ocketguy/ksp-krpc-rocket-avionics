...
# utils.launch_countdown(120, 4, vessel) # Countdown + Engine Ignition
utils.set_launch_ut(conn.space_center, "Y3, D292, 05:33:00")
vessel.control.activate_next_stage()  # Pad separation
time.sleep(3)
vessel, telem = utils.check_active_vehicle(conn.space_center, vessel,
                                               mission_params.root_vessel)
