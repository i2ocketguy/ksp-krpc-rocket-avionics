...
vessel.auto_pilot.stopping_time = (.5, 1.3, .5)
...
second = final_stage.close_loop_guidance(second, mission_params, telem, 100, mission_params.target_heading, telem_viz=telem_viz)
